...
def initial_values(inputs_dict, experiment_input, run_number, agent_inputs, AS_theory, PF_theory):
	...
	for i in range(externalparties_number):
		...
		belieftree_policy_structure1 = [None for f in range(len_PC)]
		belieftree_policy = []
		...
		if experiment_input[0][run_number] == 1:
			...
			if affiliation == 1:
				...
				belieftree_policy[0][0][0] = 0.5
				belieftree_policy[0][0][1] = 0
				belieftree_policy[0][0][2] = 0.1
				belieftree_policy[0][1][0] = -0.5
				belieftree_policy[0][1][1] = -0.5
				belieftree_policy[0][1][2] = 0
				belieftree_policy[0][2][0] = 0
				belieftree_policy[0][2][1] = 0.5
				belieftree_policy[0][2][2] = 0
				belieftree_policy[0][3][0] = 0.4
				belieftree_policy[0][3][1] = -0.5
				belieftree_policy[0][3][2] = 0
				belieftree_policy[0][4][0] = 0.2
				belieftree_policy[0][4][1] = 0
				belieftree_policy[0][4][2] = 0.5
				belieftree_policy[0][5][0] = 0
				belieftree_policy[0][5][1] = -0.9
				belieftree_policy[0][5][2] = -0.5
				belieftree_policy[0][6][0] = 0
				belieftree_policy[0][6][1] = 0.3
				belieftree_policy[0][6][2] = -0.5
				belieftree_policy[0][7][0] = 0
				belieftree_policy[0][7][1] = 0
				belieftree_policy[0][7][2] = -0.5
				belieftree_policy[0][8][0] = 0
				belieftree_policy[0][8][1] = 0.9
				belieftree_policy[0][8][2] = -0.5
				belieftree_policy[0][9][0] = 0
				belieftree_policy[0][9][1] = -0.8
				belieftree_policy[0][9][2] = -0.5
				for q in range(len(policies)):
					for p in range(len_PC):
						belieftree_policy[0][q][p] = belieftree_policy[0][q][p] + (random.random()/10) - 0.05
			...
			if affiliation == 2:
				...
				belieftree[0][5][1] = 0.1		# S1 - Camp sites
				belieftree[0][6][1] = -0.2		# S2 - Planting
				...
				belieftree[0][19][0] = 0.1		# PC1 - S4
				belieftree[0][20][0] = 0.2		# PC1 - S5
				belieftree[0][21][0] = -0.3		# PC2 - S1
				belieftree[0][22][0] = 0.4		# PC2 - S2
				belieftree[0][23][0] = 0.5		# PC2 - S3
				belieftree[0][24][0] = -0.5		# PC2 - S4
				belieftree[0][25][0] = 0.3		# PC2 - S5
				belieftree[0][26][0] = 0.2		# PC3 - S1
				belieftree[0][27][0] = 0.1		# PC3 - S2
				belieftree[0][28][0] = 0.2		# PC3 - S3
				...
				belieftree_policy[0][0][2] = 0
				belieftree_policy[0][1][0] = -0.5
				belieftree_policy[0][1][1] = 0.7
				belieftree_policy[0][1][2] = 0
				belieftree_policy[0][2][0] = 0.8
				belieftree_policy[0][2][1] = 0.5
				belieftree_policy[0][2][2] = 0
				belieftree_policy[0][3][0] = 0
				belieftree_policy[0][3][1] = -0.5
				belieftree_policy[0][3][2] = 0
				belieftree_policy[0][4][0] = -0.9
				belieftree_policy[0][4][1] = 0
				belieftree_policy[0][4][2] = 0.5
				belieftree_policy[0][5][0] = 0
				belieftree_policy[0][5][1] = 0
				...
				belieftree_policy[0][6][1] = 0
				belieftree_policy[0][6][2] = -0.5
				belieftree_policy[0][7][0] = -0.7
				belieftree_policy[0][7][1] = 0
				belieftree_policy[0][7][2] = -0.5
				belieftree_policy[0][8][0] = 0
				belieftree_policy[0][8][1] = -0.3
				belieftree_policy[0][8][2] = -0.5
				belieftree_policy[0][9][0] = 0
				belieftree_policy[0][9][1] = 0
				belieftree_policy[0][9][2] = -0.5
		...
		if experiment_input[0][run_number] == 2:
			...
			if affiliation == 2:
				...
				belieftree[0][19][0] = 0.8		# PC1 - S4
				belieftree[0][20][0] = -0.3		# PC1 - S5
				belieftree[0][21][0] = 0.1		# PC2 - S1
				belieftree[0][22][0] = 0.3		# PC2 - S2
				belieftree[0][23][0] = -0.3		# PC2 - S3
				belieftree[0][24][0] = 0.3		# PC2 - S4
				belieftree[0][25][0] = -0.4		# PC2 - S5
				belieftree[0][26][0] = 0.2		# PC3 - S1
				belieftree[0][27][0] = 0		# PC3 - S2
				belieftree[0][28][0] = 0		# PC3 - S3
